...
<head>
    ...
    <script>
        function onSubmit(token) {
            // Optionally, you can perform actions when the reCAPTCHA challenge is successfully completed.
                                ...
                                <div class="contact">
                                    <form class="form" name="enq" method="post" action="{{ route('sendEmailContactUs') }}" onsubmit="return validation();">
                                        ...
                                        <div class="row">
                                            ...
                                            <!-- Include the reCAPTCHA element with your V3 site key -->
                                            <div class="g-recaptcha" data-sitekey="{{ config('services.recaptcha_v3.site_key') }}" data-callback="onSubmit" data-action="submit"></div>
