                                    ...
                                    <div class="contact">
                                        <form class="form" name="enq" id="registrationForm" method="post" action="/registration">
                                                ...
                                                <div class="form-group col-md-5">
                                                    ...
                                                    <input type="text" name="IC_No" id="IC_No" class="form-control IC_No" placeholder="Idenfication Number / Passport" required="required">
                                                </div>
                                                ...
                                                <div class="form-group col-md-4 pe-5" >
                                                    ...
                                                    <i style="margin-top:3%;" class="bi-eye-slash password-toggle" id="togglePassword1" style="color: black;"></i>
