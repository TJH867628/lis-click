...
<body>
    ...
    @endif
        <section class="table__header">
            <h1>Application For Reviewer List</h1>
        </section>
        <section class="table__body">
            ...
            <thead>
                ...
                <tbody>
                @if($applyForReviewerList)
                    @foreach($applyForReviewerList as $thisApply)
                        <tr>
                            <td>{{ $thisApply->id }}</td>
                            ...
                            @else
                            <td><button type="button" style="background-color:grey;">This Application Had Been Approved</button></td>
                            @endif
                        </tr>
                    @endforeach
                @else
