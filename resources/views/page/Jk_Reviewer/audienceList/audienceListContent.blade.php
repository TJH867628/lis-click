    ...
    <main class="table">
        ...
        <section class="table__body">
            ...
            <thead>
                ...
                <tbody>
                @if($audienceList)
                    @foreach($audienceList as $thisAudience)
                        <tr>
                            <td>
                                {{ $thisAudience->id }}
                            </td>
                            ...
                            <td>
                                {{$thisAudience->payment_status}}
                            </td>                    
                            <td>
                                @if($thisAudience->certificate != null)
                                    Current Certificate:<br>
                                    <a href="{{ route('downloadAudienceCertificate',['filename'=>$thisAudience->certificate]) }}" target="_blank">{{$thisAudience->certificate}}</a>
                                @endif
                                @if($thisAudience->payment_status == 'Complete')
                                <br>
                                <br>Upload Certificate:<br>
                                <form action="{{ route('uploadAudienceCertificate',['id'=>$thisAudience->id]) }}" method="post" enctype="multipart/form-data" style="padding:1%; margin:1%;">
                                    @csrf
                                ...
                                @else
                                <p>"Kindly verify that the audience has completed the necessary payment validation prior to uploading the certificate."</p>
                                @endif
                            </td>   
                        </tr>
                    @endforeach
