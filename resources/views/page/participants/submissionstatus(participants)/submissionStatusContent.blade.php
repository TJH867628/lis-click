...
<div class="table-container">
        ...
        <script>
            ...
            popup.document.write("@if($paymentQR->masterdata_value != NULL)<img style='max-height:100px; max-width:100px; margin:auto;' src='{{ asset('paymentQR/'.$paymentQR->masterdata_value) }}'><br><label>{{ $paymentQR->masterdata_details }}</label><br>@else <h1>Payment QR is not available,please contact with the customer service</h1>@endif");
