                                        ...
                                        <div class="row">
                                            <div class="col-md-6" style="display: flex; position:relative;">
                                                <div class="form-group">
                                                      ...
                                                      <input type="password" name="currentPassword" class="form-control" id="currentPassword" minlength="8" maxlength="15">
                                                </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                      ...
                                                      <input type="password" name="newPassword1" class="form-control" id="newPassword1" minlength="8" maxlength="15">
                                                </div>
                                            </div>
                                            <div class="col-md-6" style="position: relative;">
                                                <div class="form-group">
                                                      <label>Confirm New Password :</label>
                                                      <input type="password" name="newPassword2" class="form-control" id="newPassword2" minlength="8" maxlength="15">
                                                </div>
