...
<html lang="en">
    ...
    <a id="originalBuild" href="/pageList" style="width: fit-content; margin:auto;">Page List</a>
        <main class="table">
            <section class="table__header">
                <h1>OFFICIAL CONTACT LIST</h1>
            </section>
            <section class="table__body">
                <table>
                    ...
                    <tbody>
                        @if(isset($officialDetails))
                        @php
                            $count = 0;
                        @endphp
                            @foreach($officialDetails as $thisDetails)
                            <form action="{{ route('saveChangeOfficialContact',['id'=>$thisDetails->id]) }}" method="post">
                            @csrf
                            @php
                                $count++
                            @endphp
                            ...
                            <td id="titleTableData">
                                    <label class="form-control" style="margin-top: 3%;" type="text" id="existingDescription" name="description" maxlength="200" required readonly>{{ trim($thisDetails->masterdata_details) }}</label>
                                </td>
                                <td id="titleTableData" style="width:0;">
                                    <textarea name="data" id="" cols="30" rows="5" maxlength="100">{{$thisDetails->masterdata_value }}</textarea>
                                </td>
                                <td>
                                    {{ $thisDetails->updated_at }}
                                </td>
