        ...
        <main class="table">
            ...
            <section class="table__body">
                <table>
                    ...
                    <tbody>
                        @if($allLogo->isNotEmpty())
                        @php
                            $count = 0;
                        @endphp
                            @foreach($allLogo as $logo)
                            <form method="post" action="{{  route('editLogo',['id' => $logo->id]) }}" enctype="multipart/form-data">
                            @csrf
                            @php
                                $count++
                            @endphp
                            <tr>
                                <td id="titleTableData" style="width:0;">
                                    <label >{{ strtoupper($logo->masterdata_name) }}</label>
                                </td>
                                <td id="img">
                                    <div class="choose-file">
                                    <img class="preview-image" id="previewImage" src="{{ $logo->masterdata_value }}"><br>
                                ...
                                <td id="titleTableData">
                                    <label class="form-control" style="margin-top: 3%;" type="text" id="existingDescription" name="description" maxlength="200" required readonly>{{ trim($logo->masterdata_details) }}</label>
                                </td>
                                <td>
                                    {{ $logo->updated_at }}
                                </td>
